...
{
    public Transform[] potentialParents;
 ...
 public int counter;
    ...
    public void Start()
    {
        potentialParents = new Transform[] {position1, position2 , position3 , position4 , position5 , position6 , position7 , position8 , position9 , position10, position11, position12, position13, position14, position15, position16, position17, position18, position19, position20, position21, position22, position23, position24, position25, position26, position27 };
        Transform randomParent = potentialParents[Random.Range(0, potentialParents.Length)];
    ...
    /*public void Test(Transform[] potentialParents)
    {
        Transform randomParent = potentialParents[Random.Range(0, potentialParents.Length)];
        transform.SetParent(randomParent);
        transform.localScale = Vector3.one;
